...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto py-6 sm:py-8 px-4 flex-grow">
        <div className="mb-8 sm:mb-10">
          <div className="text-center mb-4 sm:mb-6">
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
              Wir machen die Arbeit der Bundesregierung transparent.
              <br />
              Behalten Sie den Überblick über den Stand der Umsetzung des <a href="/assets/koalitionsvertrag.pdf" target="_blank" rel="noopener noreferrer" className="dotted-link">Koalitionsvertrags</a>.
            </p>
          </div>
