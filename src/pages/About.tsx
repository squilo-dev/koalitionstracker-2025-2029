      ...
      <main className="container mx-auto py-8 px-4 flex-grow">
        ...
        <div className="prose max-w-3xl">
          ...
          <div className="mt-8 pt-4 border-t">
            <Link to="/" className="border-b border-dotted border-gray-700">Zurück zur Startseite</Link>
          </div>
        </div>
      </main>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link to="/about" className="text-sm text-muted-foreground hover:text-coalition-primary border-b border-dotted border-muted-foreground">
                Über das Projekt
              </Link>
            </div>
          </div>
